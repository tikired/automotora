...
$sql = "SELECT 
            Ve.ID_VEHICULO, CONCAT(Mv.MARCA_VEHICULO,' ',Mv.MODELO_VEHICULO) AS MARCA_VEHICULO 
        FROM vehiculos Ve 
        INNER JOIN marca_vehiculos Mv 
            ON Ve.ID_MARCA_VEHICULO = Mv.ID_MARCA_VEHICULO
        WHERE Ve.ID_VEHICULO NOT IN (SELECT ID_VEHICULO FROM patente)";
...
<head>
	...
	<script>
		function confirmar() {
			var conf;
			conf = confirm("¿Está seguro que desea comprar el vehículo?");
			return conf;
		}
	</script>
</head>
...
<nav class="navbar navbar-inverse">
	...
	<ul class="nav navbar-nav">
        ...
        <li><a class="active" href="comprar.php">Comprar</a></li>
        ...
        <table class="table" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
						<a href="asignar.php?id=<?php echo $fila['ID_VEHICULO']; ?>">Comprar</a>
                    </td>
                </tr>
				<?php
				}
